    ...
    return (
        <section className='contacto-container'>
            ...
            <div className='contacto-informacion'>
                ...
                <InformacionContacto svg={iconoEmail} informacion='egrowersschool@gmail.com'></InformacionContacto>
                <InformacionContacto svg={iconoTelefono} informacion='2494 630209 '></InformacionContacto>
                <InformacionContacto svg={iconoWhatsapp} informacion='Whatsapp: 2494 630209'></InformacionContacto>
                <InformacionContacto svg={iconoInstagram} informacion='egrowers_school'></InformacionContacto>
            </div>
            <div className='contacto-mapa'>
                <img src={mapa} />
                <div className='contacto-mapa-informacion'>
                    <h5>COLOMBIA 489</h5>
                    <h6>Colombia 489, Tandil,
                    Buenos Aires, Argentina</h6>
                    <p>View larger map</p>
                    <img src={mapaDireccion}/>
                </div>
            </div>
